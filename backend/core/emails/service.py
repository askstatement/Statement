...
def send_email(subject: str, to_email: str, html_body: str, text_body: str = ""):
    """Send an email using Amazon SES (v1)"""
    ...
    response = ses_client.send_email(
        ...
        Message={
            ...
            "Body": {
                ...
                "Text": {
                    "Data": text_body or "Please view in HTML",
                    "Charset": "UTF-8",
                },
            },
        },
...
def send_welcome_email(user):
    ...
    html_body = render_template("welcome.html", user_email=to_email, first_name=first_name, add_unsubscribe = True)
    return send_email(subject, to_email, html_body )

def send_verification_email(to_email: str, first_name: str, verify_link: str):
    subject = "Verify Your Email"
    html_body = render_template("verify_email.html", first_name=first_name, verify_link=verify_link, add_unsubscribe = True )
    return send_email(subject, to_email, html_body)
