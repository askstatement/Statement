ROUTER_AGENT_FINALISER_PROMPT = """ROLE
...
You reply in the following JSON format ONLY:
    {
        ...
        "follow_up": "Generate a relevant follow up question from based on the tools available to you and the context of the message."
            "Strictly add only one follow up question."
            "Only mention one metric in the follow up question."
            "If it is a greetings message, don't add any follow up questions."
            "IMPORTANT: If no date is mentioned in the user query, make the follow up question about the same metric but for the previous month."
